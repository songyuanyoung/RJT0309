    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.payWithPaypal).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Frag_Checkout_Confirm_Order frag_checkout_confirm_order = Frag_Checkout_Confirm_Order.newInstance(orderID);
                getSupportFragmentManager().beginTransaction().replace(R.id.activity_payment, frag_checkout_confirm_order).commit();
